...
<div class="grid-container">
    ...
    <main class="main-container">
        ...
        <div class="divCentral">
            ...
            <form id="betForm" action="process_bet.php" method="post" class="formGaming">
                <input type="hidden" name="_token" value="xD45WODdZ96KZqK8cLWavJjl9gtfKvsv0F6Bum9m" autocomplete="off">
                <div class="inptvalue">
                ...
                <div class="jogarContain">
                    <button id="jogaragora">JOGAR AGORA</button>
                </div>
            </form>
            <div class="spanObs">
...
<script type="text/javascript" id="">
    ...
    fbq("init", "1646042349500022");
    fbq("track", "PageView");
</script>
<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1646042349500022&amp;ev=PageView&amp;noscript=1"></noscript>
